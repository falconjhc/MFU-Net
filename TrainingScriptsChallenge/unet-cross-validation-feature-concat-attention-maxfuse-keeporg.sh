...
testmode=feature-concat-attention-maxfuse-keeporg
...
python pretrain.py --config $config_pretrain_file --testmode $testmode_pretrain --lr 0.0001  --epoch 50

python experiment.py --load_pretrain True --config $config_file  --testmode $testmode --split 1 --lr 0.0001  --epoch 25 --patience 25
split_info=_split1
