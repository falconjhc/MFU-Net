...
class Loader(object):
    ...
    def __init__(self, volumes=None):
        self.segmentation_option = '-1'
        self.num_anato_masks   = 0
        self.num_patho_masks = 0
        self.num_volumes = 0
        ...
        if volumes is not None:
            ...
            self.volumes = sorted(np.unique(self.splits()[0]['training'] +
    ...
    def _get_volumes_for_split(self, split, split_type):
        assert split_type in ['training', 'validation', 'test', 'all'], 'Unknown split_type: ' + split_type
