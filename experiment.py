...
class Experiment(object):
    ...
    def get_config(self, split,  args):
        ...
        config.folder += '_' + config.testmode
        ...
        config.public_or_split = args.public_or_split
    ...
    def run_experiment(self, configuration, test):
        ...
        if test:
            executor.test(public_or_split=configuration.public_or_split)
    ...
    def read_console_parameters():
        ...
        parser.add_argument('--load_pretrain', help='load_pretrain', type=int, default=0)
